...
export const setApprovalForAlia = (content) => ({
  type: SET_APPROVAL_FOR_ALIA,
  payload: content,
});
...
export const deleteApprovalForAlia = (content) => ({
  type: DELETE_APPROVAL_FOR_ALIA,
  payload: content,
});
...
export const setDecimalsForAlia = (content) => ({
  type: SET_DECIMALS_FOR_ALIA,
  payload: content,
});
...
export const deleteDecimalsForAlia = (content) => ({
  type: DELETE_DECIMALS_FOR_ALIA,
  payload: content,
});
